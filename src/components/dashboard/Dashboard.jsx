        ...
        <Layout style={{ marginLeft: 30 }}>
          <Content style={{ padding: "24px", minHeight: 280 }}>
            <div className="gutter-example button-demo">
                ...
                <Col className="gutter-row" span={24}>
                  <div className="gutter-box" style={{ textAlign: "center" }}>
                    <Card bordered={false}>
                      <Select
                        value={
                          selectedDevice ? selectedDevice.nombre : "placeholder"
                        }
                        style={{ width: 200 }}
                      ...
                      >
                        ...
                        {dispositivos.map((device) => (
                          <Option key={device.id} value={device.nombre}>
                            {device.nombre}
                          </Option>
                        ))}
                      </Select>
              ...
              {selectedDevice ? (
                <Row gutter={10} style={{ marginBottom: "10px", width: '100%' }}>
                <Col className="gutter-row" span={8}>
                  <div className="gutter-box">
                    <Card bordered={false} style={{ width: '100%' }}>
                      <div className="clear y-center">
                        <div className="pull-left mr-m">
                          <CloudOutlined style={{ fontSize: 30, color: "#ffd700" }} />
                        </div>
                        <div className="clear">
                          <div className="text-muted">Temperatura</div>
                          <h2>{lectura ? `${Number(lectura.temperatura).toFixed(2)} °C` : "-"}</h2>
                        </div>
                      </div>
                    </Card>
                  </div>
                ...
                <Col className="gutter-row" span={8}>
                  <div className="gutter-box">
                    <Card bordered={false} style={{ width: '100%' }}>
                      <div className="clear y-center">
                        <div className="pull-left mr-m">
                          <CloudSyncOutlined style={{ fontSize: 30, color: "red" }} />
                        </div>
                        <div className="clear">
                          <div className="text-muted">Húmedad</div>
                          <h2>{lectura ? `${Number(lectura.humedad).toFixed(2)} %` : "-"}</h2>
                        </div>
                      </div>
                    </Card>
                  </div>
                    ...
                    <Card bordered={false} style={{ width: '100%' }}>
                      <div className="clear y-center">
                        ...
                        <div className="clear">
                          ...
                          <h2>{lectura ? `${Number(lectura.caudal).toFixed(2)} Q` : "-"}</h2>
                        </div>
                      </div>
                    </Card>
                  </div>
